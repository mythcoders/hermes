...
class SendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sender" do
    assert_difference("Sender.count") do
      post senders_url, params: {sender: {key: "test", name: "New sender", secret: "test", state: @sender.state, address: @sender.address}}
    end
  ...
  test "should update sender" do
    patch sender_url(@sender), params: {sender: {key: @sender.key, name: @sender.name, secret: @sender.secret, state: @sender.state}}
